...
Public Declare Function getsockopt Lib "ws2_32.dll" (ByVal s As Long, ByVal level As Long, ByVal optname As Long, optval As Any, ByRef optlen As Long) As Long
...
Public Declare Function select_ Lib "ws2_32.dll" Alias "select" (ByVal nfds As Long, readfds As Any, writefds As Any, exceptfds As Any, timeout As Any) As Long
...
Public Declare Function Socket Lib "ws2_32.dll" Alias "socket" (ByVal af As Long, ByVal stype As Long, ByVal protocol As Long) As Long
...
Public Declare Sub CopyMemory Lib "ntdll.dll" Alias "RtlMoveMemory" (lpDest As Any, lpSrc As Any, ByVal cbLen As Long)
